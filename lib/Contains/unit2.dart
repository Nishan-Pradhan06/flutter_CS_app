    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Data Communication and Networking'),
        ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          const Text(
                            'Types of data communicatin modes                                                                                                                    ',
                            textAlign: TextAlign.start,
                            style: TextStyle(
                              decoration: TextDecoration.underline,
                              fontSize: 21.0,
                          ...
                          const SelectableText(
                            "Communication system is a system designed to send information from a scource generating that information to one (Point ot point communication) or nmore (boardcasting) receivers of that information. Example of communication are the telephone, line, telegraphy, radio etc.",
                            textAlign: TextAlign.start,
                            textDirection: TextDirection.ltr,
                            style: TextStyle(
                              fontFamily: "Ubuntu",
